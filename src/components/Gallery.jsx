  ...
  useEffect(() => {
    ...
    function createMasonryGrid() {
      ...
      artworks.forEach(artwork => {
         ...
         item.innerHTML = `
            <div class="masonry-item-image" style="height: ${height}px;">
    ...
    <div  >
      <header className="header">
        ...
        <div className="search-container">
          <input type="text" className="search-input" placeholder="Search by art name, artist, event..." />
        </div>
      ...
      <main className="gallery-container" style={{ border: '20px solid rgba(0, 0, 0, 0.04)', backgroundColor: 'rgba(0,0,0,0.3)', borderRadius: '20px', backdropFilter: 'blur(8px)',height:'600px', width:'1400px'  }}>
